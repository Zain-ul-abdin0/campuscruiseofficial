				...
				'options' => array(
					...
					'top-bar-social-icon-type' => array(
						...
						'options' => array(
							...
							'font-awesome6' => esc_html__('Font Awesome 6', 'traveltour'),
						)
					),
					'top-bar-social-threads' => array(
						'title' => esc_html__('Top Bar Social Threads Link', 'traveltour'),
						'type' => 'text',
					...
					'top-bar-social-twitter' => array(
						...
						'type' => 'text',
						'condition' => array( 'enable-top-bar-social' => 'enable' ),
						'description' => esc_html__('Change \'Icon Type\' on the top to \'Font Awesome 6\' for new (X) icon', 'traveltour')
					),
