<?php
    ...
    include_once(TOURMASTER_LOCAL . '/room/include/paypal-js-sdk.php');
    ...
    include_once(TOURMASTER_LOCAL . '/room/include/pb/pb-element-room-review.php');
    include_once(TOURMASTER_LOCAL . '/room/include/pb/room-item.php');
    include_once(TOURMASTER_LOCAL . '/room/include/pb/room-style.php');
    include_once(TOURMASTER_LOCAL . '/room/include/pb/pb-element-room-feature-media.php');

    include_once(TOURMASTER_LOCAL . '/room/include/pb/pb-element-room-location.php');
    include_once(TOURMASTER_LOCAL . '/room/include/pb/pb-element-room-location-title.php');
    include_once(TOURMASTER_LOCAL . '/room/include/pb/room-location-item.php');
    include_once(TOURMASTER_LOCAL . '/room/include/pb/room-location-style.php');
